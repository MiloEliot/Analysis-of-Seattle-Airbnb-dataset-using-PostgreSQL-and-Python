...
## 2. Database Setup
The Seattle Airbnb dataset can be downloaded from [Kaggle](https://www.kaggle.com/datasets/airbnb/seattle).The first step is to review the tables and build the relationship among them. To this end, the following SQL script was written: 
